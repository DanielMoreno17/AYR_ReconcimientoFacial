...
#modelo.read(dir + 'modeloLBPHFace.xml')
###########
...
def face_detect_box(image):
    ...
    for (x, y, w, h) in faces:
        ...
        nombres =  ["Aaron", "Daniel", "Eduardo"]
        if respuesta[1] < 6000: #valor configurable ->valores mas cercanos = mayor confianza en la prediccion
